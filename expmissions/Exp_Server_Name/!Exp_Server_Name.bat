...
SET "SERVERCFG=DEBUGMODE\mpmissions\Exp_Server_Name\serverDZ.cfg"

@REM Directory to your Servers Mission Files 
SET "MISSION=DEBUGMODE\mpmissions\Exp_Server_Name\dayzOffline.chernarusplus"

@REM Directory to your Servers Profiles Folder
SET "PROFILES=DEBUGMODE\mpmissions\Exp_Server_Name\profiles"
