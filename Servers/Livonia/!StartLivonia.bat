...
SET "MISSION=%DEBUGFOLDER%\Missions\dayzOffline.enoch"
SET "SERVERCFG=%DEBUGFOLDER%\Servers\Livonia\serverDZ.cfg"
SET "PROFILES=%DEBUGFOLDER%\Servers\Livonia\profiles"
