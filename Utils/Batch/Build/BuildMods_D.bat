...
SET AddonBuilderPath="D:\SteamLibrary\steamapps\common\DayZ Tools\Bin\AddonBuilder\AddonBuilder.exe"
...
powershell -Command "Write-Host 'All mods have been built from the D Drive.' -ForegroundColor DarkCyan"
